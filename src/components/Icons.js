...
export const LinkedinIcon = ({ className, ...rest }) => {
  return (
    <svg
      ...
      {...rest}
    >
      <path d="M37.08,0H2.95C1.34-.02.02,1.28,0,2.89v34.26c.02,1.61,1.34,2.9,2.95,2.88h34.12c1.61.01,2.93-1.28,2.95-2.89V2.88C40,1.27,38.69-.01,37.08,0ZM11.87,34.13h-5.94V15.01h5.94v19.12ZM8.9,12.38c-1.9,0-3.44-1.54-3.44-3.45,0-1.9,1.54-3.44,3.44-3.44h0c1.9,0,3.45,1.54,3.45,3.44s-1.54,3.45-3.45,3.45ZM34.12,34.13h-5.94v-9.3c0-2.21-.04-5.07-3.09-5.07s-3.57,2.42-3.57,4.92v9.45h-5.93V15.01h5.7v2.62h.08c.79-1.5,2.73-3.09,5.62-3.09,6.02-.01,7.13,3.95,7.13,9.08v10.5Z" strokeWidth="0" />
    </svg>
  );
};
...
export const TwitterIcon = ({ className, ...rest }) => {
  return (
    <svg version="1.1" x="0px" y="0px" viewBox="0 0 42 38" className={cx("w-full h-auto", className)}
      {...rest} >
      <path d="M33,0h6.4L25.3,16.1L41.9,38h-13L18.7,24.7L7.1,38H0.7l15-17.2L-0.2,0h13.3l9.2,12.1L33,0z M30.8,34.2h3.6L11.3,3.6H7.4
	L30.8,34.2z"/>
    </svg>
